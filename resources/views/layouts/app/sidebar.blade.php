@if(auth()->check())
	<div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar">
		...
		<span class="tracking-widest font-normal text-sm uppercase text-gray-500 px-6 mb-3 mx-3 block">Resources</span>

		<a href="{{ route('app.home') }}" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('home-active')">
		...
		<span class="tracking-widest font-normal text-sm uppercase text-gray-500 px-6 mt-8 mb-3 mx-3 block">Sales</span>
		<a href="#" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('leads-active')">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 h-4">
		...
		<a href="#" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('clients-active')">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 h-4">
		...
		<span class="tracking-widest font-normal text-sm uppercase text-gray-500 px-6 mt-8 mb-3 mx-3 block">Managment</span>
		<a href="{{ route('app.users.index') }}" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('users-active')">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 h-4">
		...
		<a href="{{ route('app.roles.index') }}" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('roles-active')">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 h-4">
		...
		<span class="tracking-widest font-normal text-sm uppercase text-gray-500 px-6 mt-8 mb-3 mx-3 block">Core</span>
		<a href="{{ route('app.settings.index') }}" class="flex items-center font-normal text-white py-2 text-base no-underline mx-3 px-6 rounded @yield('settings-active')">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-4 h-4">
